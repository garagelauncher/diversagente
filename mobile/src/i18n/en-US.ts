...
export const kmRadius = 'Kilometers radius';

export const selectLocation = 'Select a location in the map';

export const next = 'Next';

export const createNewLocation = 'Create a new location';

export const changeLocation = 'Change location';

export const locationTitle = 'Location title';
...
export const rateLocation = 'Rate location';
...
export const giveRate = 'Give a rating: ';

export const submitRate = 'Send review';

export const soon = 'Soon';

export const december = 'For december 2022';

export const editProfile = 'Edit profile';

export const exit = 'Exit';

export const enterGoogle = 'Enter with Google';

export const saveData = 'Save data';

export const hello = 'Hello';

export const shareExperiences = 'Share experiences in the Forum';

export const shareWithCommunity = 'Share with the community';
...
export const clickHereNewPost = 'You can click here to create a new post!';
...
export const selectSubCategory = 'Select a subcategory';
...
export const addComment = 'Comment something here';
