...
\newglossaryentry{pocs} {
    name=POC,
    plural= {POCs},
    description={Proof of Concept - Prova de conceito em que é testada a arquitetura do projeto em desenvolvimento.}
}

\newglossaryentry{mvp} {
    name=MVP,
    plural= {MVPs},
    description={Minimum Valuable Product - Produto mínimo de valor, diz respeito à um produto, serviço ou funcionalidade do projeto que demonstre valor suficiente para funcionar como chamariz.}
}
...
\newglossaryentry{ssl} {
    name=SSL,
    plural= {SLL},
    description={Secure Sockets Layer - Certificado digital que autentica a identidade de um site e possibilita uma conexão criptografada.}
}
