...
\chapter{Diagrama de casos de uso Parte I}
...
\begin{longtable}{|p{3.3cm}|p{12.3cm}|}
	...
	\hline
	Fluxo Básico & Login Social (Google):
	\begin{enumerate}
...
\begin{longtable}{|p{3.3cm}|p{12.3cm}|}
	...
	\hline
	Fluxo Básico  & Cadastro com a conta Google:
	\begin{enumerate}
		\item O usuário entra no aplicativo e visualiza a tela de login;
...
%--------------------------------------------------------------
	...
	\begin{longtable}{|p{3.3cm}|p{12.3cm}|}
		...
		\begin{enumerate}
			...
			\item O sistema exibe os dados do perfil: nome, e-mail, biografia, preferência  no app e segurança e privacidade;
	...
	\begin{longtable}{|p{3.3cm}|p{12.3cm}|}
		...
		\begin{enumerate}
			\item O usuário seleciona a seção "Fórum";
   			\item O usuário seleciona "Ver mais";
...
%--------------------------------------------------------------
	...
	\begin{longtable}{|p{3.3cm}|p{12.3cm}|}
		...
		Descrição & Ao criar uma subcategoria, o cliente poderá excluir sua própria mensagem dentro do canal de texto.\\
		\hline
		Fluxo Básico  & 
		Para o cliente:
		\begin{enumerate}
			...
			\item O usuário escolhe uma subcategoria;
			\item O sistema mostra todas as mensagens ocorridas nesse canal de texto até o momento. 
			\item O usuário seleciona a sua mensagem que deseja excluir;
   			\item O usuário seleciona " Sim, tenho certeza" no pop-up que aparece para deletar a sua mensagem;
...
\pagebreak
	...
	\begin{longtable}{|p{3.3cm}|p{12.3cm}|}
		...
		Descrição & O cliente  devem conseguir criar subcategorias a partir das categorias já criadas pelo administrador.\\
		\hline
		Fluxo Básico  & 
		\begin{enumerate}
			\item O usuário seleciona a seção "Fórum";
			...
			\item O usuário escreve o nome da subcategoria, descrição  e clica em "Criar"
...
%---------------------------------------------------------------
 \begin{comment}
	...
	\begin{longtable}{|p{3.3cm}|p{12.3cm}|}
		...
		Fluxo Básico  & 
		\begin{enumerate}
			\item O usuário clica na seção 'Locais';
   			\item O usuário clica no "+" para adicionar uma local ;
			\item O usuário no mapa seleciona o local que deseja adicionar ;
			\item O usuário clica em "Próximo";
   			\item O usuário preenche os campos "Título do lugar", "Descrição";
			\item O usuário clica em "Criar local";
		...
		\begin{enumerate}
			...
			\item O usuário no mapa seleciona o local que deseja adicionar ;
			\item O usuário clica em "Próximo";
	   		\item O usuário preenche os campos "Título do lugar";
      	   	\item O botão "Criar local" não fica habilitado para criação de uma novo local;
			\item O caso de uso é encerrado. 
		\end{enumerate}
		\hline
		Pré-condições & Ter acesso à internet e estar previamente logado no aplicativo.
		\hline
		Pós-condições & O sistema mostrará a nova localização após a reinicialização do app.
		\hline
	\end{longtable}
	\fonte{Equipe diversaGente (2022)}
	%\pagebreak
...
%---------------------------------------------------------------
	...
	\begin{itemize}
		\item UC10: Consultar Locais Avaliados - Este uso de caso é abordado quando o cliente for consultar locais avaliados. O \autoref{casos-de-uso11} informa uma descrição, o fluxo básico de cadastro, pré-condições necessárias para conseguir fazer o uso de caso e pós-condições quando o uso de caso é concluído com sucesso.	
	\end{itemize}
	...
	\begin{longtable}{|p{3.3cm}|p{12.3cm}|}
		...
		\begin{enumerate}
			...
			\item O usuário visualiza a média de avaliação;
			\item O caso de uso é encerrado. 
		\end{enumerate}\\
		\hline
		Pré-condições & Ter acesso à internet e estar previamente logado no aplicativo.
	...
	\begin{itemize}
		\item UC11: Visualizar Perfil - Este uso de caso é abordado quando o cliente for visualizar o seu próprio perfil na plataforma. O \autoref{casos-de-uso14} informa uma descrição, o fluxo básico de cadastro, um fluxo alternativo, pré-condições necessárias para conseguir fazer o uso de caso e pós-condições quando o uso de caso é concluído com sucesso.\\	
	\end{itemize}
	...
	\begin{longtable}{|p{3.3cm}|p{12.3cm}|}
		...
		Fluxo Básico  & 
		\begin{enumerate}
			\item O usuário clica na parte "perfil" da aplicação;
			\item O usuário visualiza o seu perfil;
	...
	\begin{itemize}
		\item UC12: Criar um Post -Este uso de caso é abordado quando o cliente quiser criar uma postagem na plataforma. O 	\autoref{casos-de-uso17} informa uma descrição, o fluxo básico de ação, pré-condições necessárias para a realização do caso e pós-condições da ação.\\
	\end{itemize}
	...
	\begin{longtable}{|p{3.3cm}|p{12.3cm}|}
		...
		\begin{enumerate}
			...
			\item O usuário clica no botão "+" para criar o post;
			\item O usuário insere as informações necessárias para a criação do post;
			\item O usuário clica em "Criar"; 
			\item O caso de uso é encerrado. 
		\end{enumerate}\\
		\hline
		Pré-condições & Ter acesso à internet e estar previamente logado no aplicativo.\\
	...
	\begin{itemize}
		\item UC13: Remover um Post - Este uso de caso é abordado quando o cliente vai fazer a remoção de uma postagem previamente feita. O \autoref{casos-de-uso18} informa uma descrição, o fluxo básico de ação, um fluxo alternativo, pré-condições necessárias para a realização do caso e pós-condições da ação.\\
	\end{itemize}
%\pagebreak
	\begin{quadro}[htb]
		\centering
	...
	\begin{longtable}{|p{3.3cm}|p{12.3cm}|}
		...
		\begin{enumerate}
			...
			\item O usuário clica na opção "Excluir Post";
   			\item O usuário clica na opção "Sim, excluir";
	...
	\begin{itemize}
		\item UC14: Comentar Post - Este uso de caso é abordado quando o cliente fizer um comentário em uma postagem. O \autoref{casos-de-uso19} informa uma descrição, o fluxo básico de ação, pré-condições necessárias para a realização do caso e pós-condições da ação.\\
	\end{itemize}
...
%\pagebreak
	...
	\begin{itemize}
		\item UC15: Curtir Post - Este uso de caso é abordado quando o cliente realiza a ação de curtir uma postagem. O \autoref{casos-de-uso20} informa uma descrição, o fluxo básico de ação, pré-condições necessárias e pós-condições da ação.\\
...
% ----------------------------------------------------------
\chapter{Imagens obtidas em análises externas}
% ----------------------------------------------------------
\label{analiseExterna}

\begin{figure}[h]
	\centering
	\caption{\label{fig_arq_virado}Métricas Security  Part I}
...
\begin{figure}[h]
	\centering
	\caption{\label{fig_arq_virado}Métricas Security Headers Part II}
	\includegraphics[width=0.90\textwidth]{anexos/securityHeadersII.png}
	\label{securityHeadersII}
	\fonte{Equipe diversaGente (2022)}
\end{figure}

\begin{figure}[h]
	\centering
	\caption{\label{fig_arq_virado}Teste Qualys Etapa I \ac{ssl} Labs}
...
Os requisistos de um teste \autoref{casosDeUso1}, identificiam o que será testado, ou seja os testes precisam fazer o que está descrito no requisito, para aplicação diversaGente, temos um total de 9 requistos que especificam todos os testes mapeados pelos desenvolvedores e produto. 
\begin{figure}[h]
	\centering
	\caption{\label{fig_arq_virado}Requisitos Testes}
	\includegraphics[width=1\textwidth]{anexos/casosDeTeste/testesRequisitos.png}
	\label{casosDeUso1}
	\fonte{Equipe diversaGente (2022)}
\end{figure}
...
Os testes de gerenciamento de local \autoref{casosDeUso1}, detalha o que um usuário consegue fazer através da aplicação para gerenciar um local, como criar uma localização para que outros usuários ou ele mesmo possam avaliar e verificar se o lugar é adequado para o que o usuário deseja naquele momento. 

\begin{figure}[h]
	\centering
	\caption{\label{fig_arq_virado}Teste gerenciar locais}
	\includegraphics[width=1\textwidth]{anexos/casosDeTeste/testesLocais.png}
	\label{casosDeUso2}
	\fonte{Equipe diversaGente (2022)}
\end{figure}
...
Os testes de gerenciamento de review  \autoref{casosDeUso3}, detalha o que um usuário consegue fazer através da aplicação para gerenciar review, como o caminho dentro da aplicação que precisa chegar até conseguir criar e avaliar uma localização. Esse teste tem relevância para a a aplicação, pois é através dela que se consegue verificar o status atual de um local e também é um maneira de expressar uma opinião para o benefício da comunidade neurodiversa. 

\begin{figure}[h]
	\centering
	\caption{\label{fig_arq_virado}Teste gerenciar reviews}
	\includegraphics[width=1\textwidth]{anexos/casosDeTeste/testesAvaliacoes.png}
	\label{casosDeUso3}
	\fonte{Equipe diversaGente (2022)}
\end{figure}


Os testes de gerenciamento de subcategoria  \autoref{casosDeUso4}, detalha o que um usuário consegue fazer através da aplicação para gerenciar subcategoria, como o caminho dentro da aplicação que precisa chegar até conseguir criar e listar uma subcategoria . Esse teste tem o intuito de categorizar posts de maneira mais nichada para que os usuários da aplicação consigam localizar melhor assuntos de seu interesse.

\begin{figure}[h]
	\centering
	\caption{\label{fig_arq_virado}Teste gerenciar subcategorias}
	\includegraphics[width=1\textwidth]{anexos/casosDeTeste/testesSubcategorias.png}
	\label{casosDeUso4}
	\fonte{Equipe diversaGente (2022)}
\end{figure}

Os testes de gerenciamento de posts \autoref{casosDeUso5}, detalha o que um usuário consegue fazer através da aplicação para gerenciar posts, como o caminho dentro da aplicação que precisa chegar até conseguir criar, listar, editar e deletar uma subcategoria . Esse teste tem o intuito de deixar os usuários expressarem suas sensações e ideias através de postagens sobre diferentes assuntos. Os posts são parte central da aplicação pois será através deles que haverá a troca de comentários na plataforma. 

\begin{figure}[h]
	\centering
	\caption{\label{fig_arq_virado}Teste gerenciar posts}
	\includegraphics[width=0.80\textwidth]{anexos/casosDeTeste/testesPosts.png}
	\label{casosDeUso5}
	\fonte{Equipe diversaGente (2022)}
\end{figure}

Os testes de gerenciamento de posts \autoref{casosDeUso6}, detalha o que um usuário consegue fazer através da aplicação para gerenciar comentários, como o caminho dentro da aplicação que precisa chegar até conseguir criar, listar, editar e deletar comentários . Esse teste tem o intuito de fazer o usuários responder posts, fazendo com que eles consigam se expressar sobre suas opiniões e experiências convivendo e cuidando de uma pessoa neurodivergente. 



\begin{figure}[h]
	\centering
	\caption{\label{fig_arq_virado}Teste gerenciar comentários}
	\includegraphics[width=1\textwidth]{anexos/casosDeTeste/testesComentarios.png}
	\label{casosDeUso6}
	\fonte{Equipe diversaGente (2022)}
\end{figure}

Os testes de gerenciamento de cadastro social \autoref{casosDeUso7}, detalha o que um usuário consegue fazer através da aplicação para realizar o login social. Possivelmente o teste mais fácil de ser realizado na aplicação, pois é o primeiro acesso do usuário. Dentro das regras de negócio do teste, o usuário precisa ter um conta do google sendo essa a única maneira do usuário conseguir fazer login na aplicação. 

\begin{figure}[h]
	\centering
	\caption{\label{fig_arq_virado}Teste gerenciar cadastro social usuário}
	\includegraphics[width=1\textwidth]{anexos/casosDeTeste/testesLoginSocial.png}
	\label{casosDeUso7}
	\fonte{Equipe diversaGente (2022)}
\end{figure}


Os testes de gerenciamento de perfil \autoref{casosDeUso8}, detalha o que um usuário consegue fazer através da aplicação para gerenciar o seu perfil. O usuário consegue fazer algumas edições no seu perfil. 


\begin{figure}[h]
	\centering
	\caption{\label{fig_arq_virado}Teste gerenciar perfil}
	\includegraphics[width=1\textwidth]{anexos/casosDeTeste/testesPerfil.png}
	\label{casosDeUso8}
	\fonte{Equipe diversaGente (2022)}
\end{figure}

Os testes de gerenciamento de likes \autoref{casosDeUso9}, detalha o que um usuário consegue fazer através da aplicação para gerenciar likes. Teste bem simples de ser feito, pois só possui dois estados, o de um post com like e um post sem o like. Como em qualquer outra rede social, os likes podem ser um termometro para verificar o popularidade de um post dentro da aplicação, podendo ser um post útil que ajudou bastante pessoas com o seu conteúdo.

\begin{figure}[h]
	\centering
	\caption{\label{fig_arq_virado}Teste gerenciar likes}
	\includegraphics[width=1\textwidth]{anexos/casosDeTeste/testesLikes.png}
	\label{casosDeUso9}
	\fonte{Equipe diversaGente (2022)}
\end{figure}

% ----------------------------------------------------------
\chapter{Testes de Processo }
% ----------------------------------------------------------
\label{testesProcesso}
Esse apêndice trás a casos de testes de processo com resultados. 

\begin{figure}[htb]
	\centering
	\caption{\label{fig_arq_virado}Teste de Processo com Resultado - Buscar post na barra de pesquisa - Título encontrado}
	\includegraphics[width=0.50\textwidth]{anexos/casosDeTeste/resultado_ct_buscapost_encontrado.PNG}
	\label{ct_post_encontrado}
	\fonte{Equipe diversaGente, 2022}
\end{figure}
...
\begin{figure}[htb]
	\centering
	\caption{\label{fig_arq_virado}Teste de Processo com Resultado - Buscar post na barra de pesquisa - Título não encontrado}
	\includegraphics[width=0.50\textwidth]{anexos/casosDeTeste/resultado_ct_buscaPost_naoencontrado.PNG}
	\label{ct_post_nao_encontrado}
	\fonte{Equipe diversaGente, 2022}
\end{figure}

\begin{figure}[htb]
	\centering
	\caption{\label{fig_arq_virado}Teste de Processo com Resultado - Filtrar Localidade}
	\includegraphics[width=0.50\textwidth]{anexos/casosDeTeste/resultado_ct_localidade_filtro.PNG}
	\label{ct_localidade_filtro}
	\fonte{Equipe diversaGente, 2022}
\end{figure}
...
\begin{figure}[htb]
	\centering
	\caption{\label{fig_arq_virado}Teste de Processo com Resultado - Filtrar Localidade}
	\includegraphics[width=0.50\textwidth]{anexos/casosDeTeste/resultado_ct_localidade_.PNG}
	\label{ct_localidade_}
	\fonte{Equipe diversaGente, 2022}
\end{figure}
...
\begin{figure}[htb]
	\centering
	\caption{\label{fig_arq_virado}Teste de Processo com Resultado - Filtrar Localidade}
	\includegraphics[width=0.50\textwidth]{anexos/casosDeTeste/resultado_ct_localidade_detalhes.PNG}
	\label{ct_localidade_}
	\fonte{Equipe diversaGente, 2022}
\end{figure}

% ----------------------------------------------------------
\chapter{GitStats Part I }
% ----------------------------------------------------------
\label{gisStatsI}
...
\begin{figure}[htb]
	\centering
	\caption{\label{fig_arq_virado}Gitstats métricas gerais Parte I}
...
\begin{figure}[htb]
	\centering
	\caption{\label{fig_arq_virado}Gitstats métricas atividades Parte I}
...
\begin{figure}[htb]
	\centering
	\caption{\label{fig_arq_virado}Gitstats métricas autores Parte I}
...
\begin{figure}[htb]
	\centering
	\caption{\label{fig_arq_virado}Gitstats métricas arquivos Parte I}
...
\begin{figure}[htb]
	\centering
	\caption{\label{fig_arq_virado}Gitstats tags Parte I}
...
API de noticiais do governo e google news.
...
\includepdf[pages=1-5,scale=0.8,frame=true,pagecommand={}\label{publicacao-blogII}]{anexos/BlogSemestre2.pdf}
