...
\defSiglaIngles{mvp}{MVP}{Minimum Valuable Product}{Produto Mínimo de Valor}

\defSiglaIngles{poc}{POC}{Proof of Concept}{Prova de Conceito}

\defSiglaIngles{ssl}{SSL}{Secure Sockets Layer}{Camada Segura de Soquetes}

\defSigla{crud}{CRUD}{Create, Read, Update, Delete}

\defSigla{rest}{REST}{Representational State Transfer}

\defSiglaIngles{xxs}{XXS}{Cross Site Scripting}{Escrita entre sites}

\defSigla{mb}{MB}{Megabyte}

\defSiglaIngles{eua}{EUA}{Estados Unidos da América}{United States of America}
...
\defSiglaIngles{url}{URL}{Uniform Resource Locator}{Localizador Padrão de Recursos}

\defSiglaIngles{ide}{IDE}{Integrated Development Environment}{ Ambiente integrado de desenvolvimento}

\defSiglaIngles{html}{HTML}{Hypertext Markup Language}{Linguagem de marcação de hipertexto}

\defSiglaIngles{https}{HTTPS}{Hypertext Transfer Protocol Secure}{Protocolo Seguro de transferência de hipertexto}
...
\defSigla{ccd}{CCD}{Centro de Controle de Doenças e Prevenção}

\defSigla{cd}{CD}{Continuous Delivery}

\defSigla{aws}{AWS}{Amazon Web Services}

\defSigla{ci}{CI}{Continuous Integration}

\defSigla{cdn}{CDN}{Content Delivery Network}

\defSigla{tdah}{TDAH}{Transtorno do déficit de atenção com hiperatividade}
